...
export const metadata: Metadata = {
  title: "WekangTrading 🏍️💰 - Professional Trading Performance Analytics",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "WekangTrading - Fast motorcycle with money",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "WekangTrading 🏍️💰",
    description: "Speed up your trading success!",
    images: ["/og-image.png"],
  },
};
