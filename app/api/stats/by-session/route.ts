 ...
 * GET /api/stats/by-session?period=week|month|year|all
 * 
 * Returns trading performance broken down by market session
 */

import { NextRequest, NextResponse } from 'next/server';
import { auth } from '@/lib/auth';
import { getSessionStats } from '@/lib/services/statsService';
import { z } from 'zod';
