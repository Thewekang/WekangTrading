/**
 * Trades Page Contextual Quote
 * Pinned quote at top of trades page
 * Weighted based on last 3 trades and weekly performance
 */
...
function getMoodText(context: TradesPageQuoteData['context']): string {
...
export function TradesPageQuote() {
