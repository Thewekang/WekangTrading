...
CREATE TABLE "new_daily_summaries" (
    ...
    "asia_session_wins" INTEGER NOT NULL DEFAULT 0,
    "europe_session_trades" INTEGER NOT NULL DEFAULT 0,
    "europe_session_wins" INTEGER NOT NULL DEFAULT 0,
    "us_session_trades" INTEGER NOT NULL DEFAULT 0,
    "us_session_wins" INTEGER NOT NULL DEFAULT 0,
    "overlap_session_trades" INTEGER NOT NULL DEFAULT 0,
    "overlap_session_wins" INTEGER NOT NULL DEFAULT 0,
    "best_session" TEXT,
    "notes" TEXT,
